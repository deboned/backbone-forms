...
QUnit.test('Transforms camelCased string to words', function() {
...
;(function() {
  ...
  QUnit.test('returns a compiled template if just passed a string', function() {
  ...
  QUnit.test('returns a template compiled with a different templating program, when just passed a string - e.g. Handlebars', function() {
  ...
  QUnit.test('works when underscore template settings are different and restores them when done', function() {
  ...
  QUnit.test('returns the supplanted string if a context is passed', function() {
...
;(function() {
  ...
  QUnit.test('Compiles strings into templates', function() {
    var self = this;
  ...
  QUnit.test('Takes already compiled templates', function() {
    var templates = {
  ...
  QUnit.test('Sets custom templates', function() {
    var templates = {
  ...
  QUnit.test('Sets class names', function() {
    var classNames = {
      error: 'customError'
    };
  ...
  QUnit.test('Can be called via Form.setTemplates shortcut', function() {
...
(function() {
    ...
    QUnit.test('Accepts strings for included editors', function() {
    ...
    QUnit.test('Accepts editor constructors', function() {
...
(function() {
  ...
  QUnit.test('Given a string, a bundled validator is returned', function() {
  ...
  QUnit.test('Given a string, throws if the bundled validator is not found', function() {
    expect(1);
  ...
  QUnit.test('Given an object, a customised bundled validator is returned', function() {
  ...
  QUnit.test('Given a regular expression, returns a regexp validator', function() {
